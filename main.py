...
#set webpage title, header and subtitle
...
#read file
movies_data = pd.read_csv("https://raw.githubusercontent.com/danielgrijalva/movie-stats/master/movies.csv")
movies_data.info()
movies_data.duplicated()
movies_data.count()
movies_data.dropna()

# Create sidebar widget filters from movies dataset
...
# #See data summary and duplicate values
# #movies_data.info()
# #print(movies_data.duplicated())

# #Check for missing columns and drop them
...
# fig = plt.figure(figsize = (19, 10)) 
# plt.bar(genre, avg_bud, color = 'grey')
# plt.xlabel('genre')
# plt.ylabel('budget')
# plt.title('Matplotlib bar chart showing the average budget of movies in each genre')
# st.pyplot(fig)